...
/* $begin errorfuns */
/* $begin unixerror */
void unix_error(const std::string& msg) /* Unix-style error */
{
...
void posix_error(int code, const std::string& msg) {  /* Posix-style error */
    fprintf(stderr, "%s: %s\n", msg.c_str(), strerror(code));
    exit(0);
}

void gai_error(int code, const std::string& msg) /* Getaddrinfo-style error */
{
    fprintf(stderr, "%s: %s\n", msg.c_str(), gai_strerror(code));
    exit(0);
}

void app_error(const std::string& msg) {/* Application error */
    fprintf(stderr, "%s\n", msg.c_str());
    exit(0);
}
...
void dns_error(const std::string& msg) /* Obsolete gethostbyname error */
{
    fprintf(stderr, "%s\n", msg.c_str());
    exit(0);
}
